...
public class VectorFieldDialog extends JDialog implements ActionListener
{
	private Term m_term;
	private PdVector m_pos;
	private JButton m_okButton;
	private JButton m_cancelButton;
	private VectorFieldPanel m_panel;
	public VectorFieldDialog(Frame owner, PdVector point)
	{
		super(owner);
		m_pos = point;
